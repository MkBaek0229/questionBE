...
SELECT * FROM expert WHERE email = 'alsrl6678@naver.com';


DELETE FROM User WHERE email = 'alsrl6678@naver.com';
DELETE FROM expert WHERE email = 'mingibaeg244@gmail.com';
...
ALTER TABLE assignment CHANGE COLUMN user_id expert_id INT NOT NULL COMMENT '전문가 ID';

ALTER TABLE assignment 
ADD CONSTRAINT fk_assignment_expert FOREIGN KEY (expert_id) REFERENCES expert(id) ON DELETE CASCADE;

INSERT INTO assignment (expert_id, systems_id, assigned_at, feedback_status)
VALUES (6, 2, NOW(), FALSE);
